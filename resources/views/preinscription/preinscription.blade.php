<x-app-layout>
    ...
    <div class="bg-gray-100 text-gray-800 p-6">
        ...
        <form action="{{ route('preinscriptionValidation') }}" method="POST" class="space-y-6 bg-white p-6 rounded-lg shadow-md" enctype="multipart/form-data">
            @csrf
            ...
            <div class="flex justify-between">
                <div class="flex-1 mr-4">
                    ...
                    <input type="text" id="matricule" name="matricule" placeholder="Ne pas remplir ce champ" class="w-full p-2 border-b border-gray-300 focus:outline-none focus:ring focus:ring-blue-400 @error('matricule') border-red-500 @enderror" value="{{ old('matricule') }}">
                    @error('matricule')
