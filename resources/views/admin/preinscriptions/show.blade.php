                ...
                <fieldset class="border-none mb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <p class="underline w-2/3">{{ $preInscription->mention_id }}</p>
                        </div>
                        <div class="flex items-center">
                        ...
                        <div class="flex items-center">
                            ...
                            <p class="underline w-2/3">{{ $preInscription->speciality_id }}</p>
                        </div>
                        <div class="flex items-center">
                ...
                <fieldset class="border-none mb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex items-center">
                            ...
                            <p class="underline w-2/3">{{ $preInscription->financement_id }}</p>
                        </div>
                        <div class="flex items-center">
                            <label class="block mb-1 font-bold w-1/3">Mode de paiement :</label>
                            <p class="underline w-2/3">{{ $preInscription->payment_mode_id}}</p>
                        </div>
                    </div>
                </fieldset>
